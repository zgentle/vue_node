<template>
  <div class="peipei">
    <div class="content">
      <span>师妹：</span>
      <p>首先跟你说声抱歉，很抱歉因为我的表达给你所带来的困扰。原本我只是想表达对你的欣赏与喜爱，不希望你会因此感受到压力，然后我们便慢慢彼此疏远了。</p>
      <p>一切始料未及，但我不会后悔去表达，我说出了我想说的话我觉得已经很圆满了，你知道我喜欢你就好，我知道你快乐就好。我所期待的感情是不慌不忙；是心之所向；是我喜欢你，刚刚好你也是；如果不是，顺其自然便好。</p>
      <p>我一直觉得沟通是解决问题最直接的办法，所以上次本想约你好好聊聊，听听你内心的想法，很多问题说开了便也不再是问题。可惜你拒绝了，所以我冷静了几天，一是不想你感受到压力，二是可以好好反思下自己。但我觉得还是有必要解释一下，不是所有故事都有美好结局，但至少不能残缺。</p>
      <p>我没有你想象的那么激进，也没有你想象的那么脆弱，所以不用刻意的保持距离，我依然是我，希望你仍旧是你。</p>
      <p>我依然会是一个乐观的人，会去好好努力，好好提升自己，努力成为一个更好的自己。</p>
      <p>当头发花白，步履蹒跚时还能唤你一声师妹便好。</p>
      <p>当浪花翻腾之后，一切仍会归于平静，我仍愿是那个你可以倾诉的师兄，你是否依然愿意做回那个简单快乐随意的师妹。</p>
      <p>最后哈哈一笑让这所有的尴尬随风而逝。</p>
      <p>能遇见你真好</p>
      <p>能认识你真好</p>
      <div class="touch icon icon-pointclick" @click="opendialog"></div>
    </div>
    <el-dialog
